...
export function Hero() {
  return (
    <section className="section-hero relative overflow-x-clip pb-20 pt-20 md:pb-28 md:pt-28">
      <PageContainer className="relative grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(260px,400px)] lg:gap-16">
        <div>
